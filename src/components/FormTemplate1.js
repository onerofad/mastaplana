...
const FormTemplate1 = ({mobile}) => {
    ...
    return(
        ...
        <Segment vertical style={{backgroundColor: '#133467', margin: mobile ? 20 : 40}}>
                <Grid>
                    <Grid.Row>
                        <Grid.Column width={mobile ? 8 : 6} verticalAlign="middle">
                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Segment vertical style={{padding: 20, borderRadius: 10, backgroundColor: '#fff'}}>
                                <Grid>
                                    <Grid.Row>
                                        <Grid.Column width={mobile ? 8 : 6} style={{marginTop: 10}}>
                                            <TextArea  placeholder="type..." style={{ minWidth: '100%', minHeight: 300}} />
                                        </Grid.Column>
                                        <Grid.Column width={mobile ? 8 : 4} style={{marginTop: 10}}>
                                            <Grid>
                                                <Grid.Row>
                                                    <Grid.Column>
