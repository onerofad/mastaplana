...
import { Button, Container, Divider, Dropdown, Form, Grid, Header, Icon, Modal, Segment } from "semantic-ui-react"
...
export const DataBank = ({mobile}) => {
    ...
    const folders  = [
        {key: 1, value: 'folder 1', text: 'folder 1'}
    ]
    ...
    const handleFolderName = (e) => {
        ...
        //let myBlob = new File([mastaplana_file], {type: 'text/plain',})
        var file = new File(["Welcome to mastaplana"], "welcome.txt", {type: "text/plain"})
                                    ...
                                    <Grid.Row>
                                        ...
                                        <Grid.Column width={6}>
                                            <Grid>
                                                <Grid.Row>
                                                    <Grid.Column>
                                                        <Header textAlign="center" as="h4" attached content="Data Folders" />
                                                    </Grid.Column>
                                                </Grid.Row>
                                            </Grid> 
                                        </Grid.Column>
